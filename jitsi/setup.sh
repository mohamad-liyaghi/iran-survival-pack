...
echo "  ── SSL ──"
echo ""
echo "  RECOMMENDED: Get a real Let's Encrypt cert (no warnings ever):"
echo "    make cert"
echo ""
echo "  If using the self-signed cert:"
echo "    - If Chrome shows HSTS error (can't click Advanced):"
echo "        chrome://net-internals/#hsts → Delete: ${JITSI_HOST}"
echo "    - To remove warnings on all devices, install the CA cert:"
echo "        Open ${PUBLIC_URL}/ca.crt → save SurvivalPackCA.crt"
